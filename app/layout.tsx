...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth h-full">
      {/* --- THIS IS THE CHANGE --- */}
      {/* Added `overflow-x-hidden` to the body tag to prevent horizontal scrolling sitewide. */}
      <body className={`${inter.variable} ${playfairDisplay.variable} ${lustria.variable} font-sans bg-classic-cream flex flex-col min-h-full overflow-x-hidden`}>
        <AuthProvider>
